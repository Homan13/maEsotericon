          ...
          <div className="col-lg-8 mx-auto">
            ...
            <div className="mx-auto text-center">
              <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" >
                ...
                <input type="hidden" name="business" value="jmartinezafam@gmail.com" />
                ...
                <input type="hidden" name="bn" value="PP-ShopCartBF:btn_cart_LG.gif:NonHostedGuest" />
                  <table>
                    ...
                    <option value="In Person (Donation)">In Person (Donation) $1.25 USD</option>
                    <option value="Executive (Donation)">Executive (Donation) $1.50 USD</option>
                    </select> </td></tr>
                  </table>
                <input type="hidden" name="option_select0" value="Virtual Only (Donation)" />
                <input type="hidden" name="option_amount0" value="1.00" />
                <input type="hidden" name="option_select1" value="In Person (Donation)" />
                <input type="hidden" name="option_amount1" value="1.25" />
                <input type="hidden" name="option_select2" value="Executive (Donation)" />
                <input type="hidden" name="option_amount2" value="1.50" />
